...
const Details = ({ meta, file, toggle, toggleShare, uploadOwner }) => {
      ...
      <div className="modal-body">
        <div className="nk-file-details">
          ...
          <div className="nk-file-details-row">
            ...
            <div className="nk-file-details-col"> {file.meta.uploadOwner} </div>
          </div>
          <div className="nk-file-details-row">
          ...
          <div className="nk-file-details-row">
            ...
            <div className="nk-file-details-col">{file.meta.date} at {file.meta.time}</div>
          </div>
        </div>
      </div>
